...
# Define a function to preprocess the image for both models
...
# Define a function to check if the image is a monkey using MobileNetV2
def is_monkey(image):
    processed_image = preprocess_image_mobilenet(image)
    predictions = mobilenet_v2.predict(processed_image)
